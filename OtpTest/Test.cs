...
namespace Otp
{
    class Test
    {
		...
		static public void Main(String[] args)
        {
            ...
            string cookie = "knowledge";
            string host = System.Net.Dns.GetHostName();
            string remote = "knowledge_game@192.168.70.124";//(args[0].IndexOf('@') < 0) ? args[0] + "@" + host : args[0];
            string nodename = "donet_node@192.168.70.123";//Environment.UserName + "123@" + host;
            ...
            OtpNode node = new OtpNode(true, nodename, cookie, true);
            ...
            try
            {
                ...
                mbox.registerName("dotnet_node_name");
