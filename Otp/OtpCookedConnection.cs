	...
	**/
    public class OtpCookedConnection:AbstractConnection
	{
		...
		*/
        ...
        //public void onRequestMessage(OtpMsg msg)
        //{
        //    if (msg.getMsg() is Otp.Erlang.Tuple)
        //    {
        //        Otp.Erlang.Tuple m = msg.getMsg() as Otp.Erlang.Tuple;
        //        if (m.arity() == 3 && m.elementAt(0) is Otp.Erlang.Pid)
        //        {
        //            if (m.elementAt(1) is Erlang.String)
        //            {
        //                switch (m.elementAt(1).stringValue())
        //                {
        //                    case "create_room":
        //                        if (m.elementAt(2) is Erlang.Tuple)
        //                        {
        //                            Erlang.Tuple room_info = m.elementAt(2) as Erlang.Tuple;
        //                            if (room_info.arity() == 2)
        //                            {
        //                                GameLogic gameLogic = new GameLogic();
        //                                int roomId = room_info.elementAt(0).intValue();
        //                                int maxPlayer = room_info.elementAt(1).intValue();
        //                                gameLogic.roomId = roomId;
        //                                gameLogic.maxPlayer = maxPlayer;
        //                                if (logicList == null)
        //                                {
        //                                    logicList = new Dictionary<int, GameLogic>();
        //                                }
        //                                if (!logicList.ContainsKey(roomId))
        //                                {
        //                                    logicList.Add(roomId, gameLogic);
        //                                }
        //                                System.Console.Out.WriteLine("Create Room roomid:" + roomId + " current list count is :" + logicList.Count);
        //                            }
        //                        }
        //                        break;
        //                    case "get_room_info":
        //                        if (m.elementAt(2) is Erlang.Tuple)
        //                        {
        //                            Erlang.Tuple roomInfo  = m.elementAt(2) as Erlang.Tuple;
        //                            if (roomInfo.arity() == 1)
        //                            {
        //                                int roomId = roomInfo.elementAt(0).intValue();
        //                                if (logicList == null)
        //                                {
        //                                    logicList = new Dictionary<int, GameLogic>();
        //                                    System.Console.Out.WriteLine(" logic list count is :" + logicList.Count);
        //                                }
        //                                else
        //                                {
        //                                    GameLogic gameLogic = null;
        //                                    logicList.TryGetValue(roomId, out gameLogic);
        //                                    int maxplayer = 0;
        //                                    if (gameLogic != null)
        //                                    {
        //                                        maxplayer = gameLogic.maxPlayer;
        //                                        System.Console.Out.WriteLine("find logic roomid :" + gameLogic.roomId + " max player: "+gameLogic.maxPlayer);
        //                                    }
        //                                    else
        //                                    {
        //                                        System.Console.Out.WriteLine("could not find game logic roomid :" + roomId);
        //                                    }

        //                                    {

        //                                        //send(self.whereis("dotnet_node_name").AsPid(), String.Format("knowledge_game@192.168.70.124"), sendMsg);
        //                                        Otp.OtpMbox mbox = self.mboxes.get(self.whereis("dotnet_node_name").AsPid());
        //                                        try
        //                                        {
        //                                            Erlang.Object MsgObject = Erlang.Object.Format("game logic roomid {0} maxplayer {1}", roomId, maxplayer);
        //                                            OtpMsg sendMsg = new OtpMsg(OtpMsg.Tag.sendTag, msg.getSenderPid(), m.elementAt(0) as Erlang.Pid, MsgObject);
        //                                            mbox.rpcCall("knowledge_game@192.168.70.124", "game_logic_node", "room_info", new Erlang.List(new Erlang.Int(roomId), new Erlang.Int(maxplayer)));
        //                                        }
        //                                        catch (Exception ex)
        //                                        {
        //                                            System.Console.Out.WriteLine("ex:" + ex.ToString());
        //                                        }
